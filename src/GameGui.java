...
public class GameGui extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(e.getActionCommand().equals("Open"))//to start the game you have to open a maze file. this is on the menu
        {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) 
            {
                ...
                fl.loadFile(directorio);//load the file we need
    ...
    private JLabel imageLabel;
        public mazeObject(String fileName)
        {
            ...
            String currentFile = path + fileName + ".png";
            ///fileName+=".png";
            JLabel fancyLabel;
    ...
    {
        timely.stop();
        JLabel yousuckLabel = new JLabel("",new ImageIcon("./Imagenes/yousuck.jpg"),JLabel.LEFT);
        cp.add(yousuckLabel);
        remove(newPanel);
        remove(progBarPanel);
        pack();
